<?php
if (isset($_GET['dr_jsess']) && $_GET['dr_jsess'] == 1) {
    header("Location: https://www.novada.com/", true, 302);
    exit;
}
...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 788;
        $headers['auth']['clientCompany'] = "6Uv4eCH8UHCjGKdYCqS0";
        $headers['auth']['clientSecret'] = "Nzg4NlV2NGVDSDhVSENqR0tkWUNxUzBjZTY2ZjZlNmY5ZGVmNTEwYWM0MGJhMmU2NWMyYWNkYTAxNDJmZmFl";
